...
class Player(pg.sprite.Sprite):
    ...
    def load_images(self):
        self.left_frames = [pg.transform.scale(self.game.pspritesheet.get_image(9, 11, 12, 12), (20, 20)),
                            pg.transform.rotate(
                                pg.transform.scale(self.game.pspritesheet.get_image(40, 11, 12, 12), (20, 20)), 180),
                            pg.transform.rotate(
                                pg.transform.scale(self.game.pspritesheet.get_image(9, 43, 12, 12), (20, 20)), 180),
                            pg.transform.rotate(
                                pg.transform.scale(self.game.pspritesheet.get_image(40, 43, 12, 12), (20, 20)), 180)]
        self.right_frames = [pg.transform.scale(self.game.pspritesheet.get_image(9, 11, 12, 12), (20, 20)),
                             pg.transform.scale(self.game.pspritesheet.get_image(40, 11, 12, 12), (20, 20)),
                             pg.transform.scale(self.game.pspritesheet.get_image(9, 43, 12, 12), (20, 20)),
                             pg.transform.scale(self.game.pspritesheet.get_image(40, 43, 12, 12), (20, 20))]
        self.up_frames = [pg.transform.scale(self.game.pspritesheet.get_image(9, 11, 12, 12), (20, 20)),
                          pg.transform.rotate(
                              pg.transform.scale(self.game.pspritesheet.get_image(40, 11, 12, 12), (20, 20)), 90),
                          pg.transform.rotate(
                              pg.transform.scale(self.game.pspritesheet.get_image(9, 43, 12, 12), (20, 20)), 90),
                          pg.transform.rotate(
                              pg.transform.scale(self.game.pspritesheet.get_image(40, 43, 12, 12), (20, 20)), 90)]
        self.down_frames = [pg.transform.scale(self.game.pspritesheet.get_image(9, 11, 12, 12), (20, 20)),
                            pg.transform.rotate(
                                pg.transform.scale(self.game.pspritesheet.get_image(40, 11, 12, 12), (20, 20)), 270),
                            pg.transform.rotate(
                                pg.transform.scale(self.game.pspritesheet.get_image(9, 43, 12, 12), (20, 20)), 270),
                            pg.transform.rotate(
                                pg.transform.scale(self.game.pspritesheet.get_image(40, 43, 12, 12), (20, 20)), 270)]
...
class GhostRED(pg.sprite.Sprite):
    ...
    def load_images(self):
        self.left_frames = [self.game.rgspritesheet.get_image(148, 57.5, 20, 20),
                            self.game.rgspritesheet.get_image(20, 57.5, 20, 20)]
        self.right_frames = [self.game.rgspritesheet.get_image(148, 185, 20, 20),
                             self.game.rgspritesheet.get_image(276, 185, 20, 20)]
        self.up_frames = [self.game.rgspritesheet.get_image(20, 185, 20, 20),
                          self.game.rgspritesheet.get_image(276, 57.5, 20, 20)]
        self.down_frames = [self.game.rgspritesheet.get_image(20, 315, 20, 20),
                            self.game.rgspritesheet.get_image(148, 315, 20, 20)]
        for image in self.left_frames:
            image.set_colorkey(BLACK)
        for image in self.right_frames:
            image.set_colorkey(BLACK)
    ...
    def update(self):
        ...
        # BOTTOM, TOP, LEFT
        if [self.side['bottom'], self.rect.x] in self.wt and [self.side['top'], self.rect.x] in self.wb and [
            self.side['left'], self.rect.y] in self.wr:
            self.last_move = ['x', 1]
            self.xPos = self.move
            self.yPos = 0
            # print("N1")
        ...
        # BOTTOM, TOP, RIGHT
        elif [self.side['bottom'], self.rect.x] in self.wt and [self.side['top'], self.rect.x] in self.wb and [
            self.side['right'], self.rect.y] in self.wl:
            self.last_move = ['x', -1]
            self.xPos = -self.move
            self.yPos = 0
            # print("N2")
...
class GhostORANGE(pg.sprite.Sprite):
    ...
    def load_images(self):
        self.left_frames = [self.game.ogspritesheet.get_image(148, 57.5, 20, 20),
                            self.game.ogspritesheet.get_image(20, 57.5, 20, 20)]
        self.right_frames = [self.game.ogspritesheet.get_image(148, 185, 20, 20),
                             self.game.ogspritesheet.get_image(276, 185, 20, 20)]
        self.up_frames = [self.game.ogspritesheet.get_image(20, 185, 20, 20),
                          self.game.ogspritesheet.get_image(276, 57.5, 20, 20)]
        self.down_frames = [self.game.ogspritesheet.get_image(20, 315, 20, 20),
                            self.game.ogspritesheet.get_image(148, 315, 20, 20)]
        for image in self.left_frames:
            image.set_colorkey(BLACK)
        for image in self.right_frames:
            image.set_colorkey(BLACK)
...
class GhostPINK(pg.sprite.Sprite):
    ...
    def load_images(self):
        self.left_frames = [self.game.pgspritesheet.get_image(148, 57.5, 20, 20),
                            self.game.pgspritesheet.get_image(20, 57.5, 20, 20)]
        self.right_frames = [self.game.pgspritesheet.get_image(148, 185, 20, 20),
                             self.game.pgspritesheet.get_image(276, 185, 20, 20)]
        self.up_frames = [self.game.pgspritesheet.get_image(20, 185, 20, 20),
                          self.game.pgspritesheet.get_image(276, 57.5, 20, 20)]
        self.down_frames = [self.game.pgspritesheet.get_image(20, 315, 20, 20),
                            self.game.pgspritesheet.get_image(148, 315, 20, 20)]
        for image in self.left_frames:
            image.set_colorkey(BLACK)
        for image in self.right_frames:
            image.set_colorkey(BLACK)
...
class GhostBLUE(pg.sprite.Sprite):
    ...
    def load_images(self):
        self.left_frames = [self.game.bgspritesheet.get_image(148, 57.5, 20, 20),
                            self.game.bgspritesheet.get_image(20, 57.5, 20, 20)]
        self.right_frames = [self.game.bgspritesheet.get_image(148, 185, 20, 20),
                             self.game.bgspritesheet.get_image(276, 185, 20, 20)]
        self.up_frames = [self.game.bgspritesheet.get_image(20, 185, 20, 20),
                          self.game.bgspritesheet.get_image(276, 57.5, 20, 20)]
        self.down_frames = [self.game.bgspritesheet.get_image(20, 315, 20, 20),
                            self.game.bgspritesheet.get_image(148, 315, 20, 20)]
        for image in self.left_frames:
            image.set_colorkey(BLACK)
        for image in self.right_frames:
            image.set_colorkey(BLACK)
